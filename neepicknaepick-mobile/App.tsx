    ...
    <QueryClientProvider client={queryClient}>
      <SafeAreaView style={{ flex: 1, backgroundColor: '#f5f1ea' }}>
        <View style={{ padding: 24, gap: 18 }}>
          <Text style={{ fontSize: 34, fontWeight: '900', color: '#2a241f' }}>NeepickNaepick</Text>
          <Text style={{ fontSize: 17, color: '#74685d', lineHeight: 24 }}>
            니픽내픽은 친구끼리 선택지를 올리고 기준별로 승자를 고르는 범용 앱입니다. 첫 번째 대표 카테고리는 점심 배틀 니밥내밥입니다.
          </Text>
          <BattleCategoryChips />
          <View style={{ backgroundColor: '#ffffff', borderRadius: 28, padding: 18, gap: 12, borderWidth: 1, borderColor: '#eadfce' }}>
            <Text style={{ color: '#98734d', fontWeight: '900' }}>니밥내밥 · DAILY LUNCH BATTLE</Text>
            <Text style={{ fontSize: 24, fontWeight: '900', color: '#2a241f' }}>오늘 점심 승자는?</Text>
            <Text style={{ color: '#74685d' }}>맛·가성비·다이어트 기준으로 친구끼리 먼저 고르고, 애매하면 커뮤니티가 판정해요.</Text>
          </View>
        </View>
      </SafeAreaView>
    </QueryClientProvider>
